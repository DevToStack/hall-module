...
const HeroSection = () => {
    return (
        <section className="flex max-md:flex-col bg-[url('/image1.jpg')] bg-transparent py-16 px-4 sm:px-8 lg:px-24 flex items-center justify-center w-full min-h-[90vh]  bg-center bg-cover">
