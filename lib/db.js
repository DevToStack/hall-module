...
if (!process.env.MYSQLUSER || !process.env.MYSQL_ROOT_PASSWORD || !process.env.MYSQLDATABASE || !process.env.MYSQLHOST) {
...
const dbUrl = new URL(`mysql://${MYSQLUSER}:${MYSQL_ROOT_PASSWORD}@${MYSQLHOST}:${MYSQLPORT}/${MYSQLDATABASE}`);
if (!dbUrl) {
  throw new Error('❌ DATABASE_URL is not set in environment variables');
}
// use MYSQL_URL to connect
