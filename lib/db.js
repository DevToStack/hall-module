...
async function initializeDatabase() {
  ...
  try {
    ...
    `)
    await connection.query(`INSERT INTO apartments (title, description, location, price_per_night, image_url, available)
      VALUES ('Cozy Downtown Apartment', 'Nice cozy apartment.', 'New York, NY', 120.00, '...', 1)
