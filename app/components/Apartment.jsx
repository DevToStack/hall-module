...
// Dynamic feature icon component
const AmenityIcon = ({ type }) => {
    ...
    const iconMap = {
        ...
        parking: solidIcons.faParking,
        pool: solidIcons.faSwimmingPool,
        kitchen: solidIcons.faKitchenSet,
        ac: solidIcons.faSnowflake,
        tv: solidIcons.faTv,
        laundry: solidIcons.faSoap,
        gym: solidIcons.faDumbbell,
        // Add more mappings as needed
    };

    const iconKey = type.toLowerCase();
    const icon = iconMap[iconKey] || solidIcons.faHome;
                ...
                <div className={`${isFullScreen ? 'mb-8' : 'text-center mb-12'}`}>
                    {isFullScreen ? (
                        <div className="flex justify-between items-center mb-6">
                            ...
                            <h2 className="text-2xl font-bold text-white">All Apartments</h2>
